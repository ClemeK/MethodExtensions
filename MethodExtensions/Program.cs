...
using RecipeBooks;
using static MethodExtensions.Konsole;
...
do
{
    ...
    Konsole.DrawLine(80, '*');
    Konsole.DisplayLine(80, "Method Extensions", Justify.Center);
    Konsole.DrawLine(80, '*');
    ...
    //Konsole.DisplayMenu1(menuOptions);
    Konsole.DisplayMenu2(menuOptions, menuKey);

    //string choose = Konsole.InputString("Select a menu option", "123456789Q").ToUpper();
...
void ArrayMethods()
{
    ...
    Console.WriteLine($"Mean average - {IntArray.AverageMean()}");
    Console.WriteLine($"Median average - {IntArray.AverageMedian()}");
    Console.WriteLine($"Mode average - {IntArray.AverageMode()}");
    Console.WriteLine();
    ...
    Console.WriteLine($"Mean average - {FloatArray.AverageMean()}");
    Console.WriteLine($"Median average - {FloatArray.AverageMedian()}");
    Console.WriteLine($"Mode average - {FloatArray.AverageMode()}");
    Console.WriteLine();
...
void ListMethods()
{
    ...
    Console.WriteLine($"Mean average - {IntList.AverageMean()}");
    Console.WriteLine($"Median average - {IntList.AverageMedian()}");
    Console.WriteLine($"Mode average - {IntList.AverageMode()}");
    ...
    Console.WriteLine($"Mean average - {FloatList.AverageMean()}");
    Console.WriteLine($"Median average - {FloatList.AverageMedian()}");
    Console.WriteLine($"Mode average - {FloatList.AverageMode()}");
